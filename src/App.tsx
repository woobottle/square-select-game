...
import { initialStage, initialTime, initialScore } from './common/constants/index';
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <GameBoard timeRef={timeRef} stage={stage} setStage={setStage} setTime={setTime} setScore={setScore}/> 
    </div>
  );
}
